...
A0 = orth(A0')';
A = A0*OmegaT; % !NEW Measurement matrix with transform

H = A*Phi; 
y = A0*MMatrix*OmegaT*s; % !NEW Measurement of the freq-domain corrupt signal
...
disp(["PSNR: " psnr(s_hat,Omega*MMatrix*x)])
disp(["PDR: " norm(s_hat-s)./norm(s)])
